...
(function () {
  var DICT = {
    ko: {},
    en: {
      "주문 취소": "Order cancelled",
      /* 직원 화면 주문·환불 (2026-09-23) */
      "환율을 읽지 못해 직원 환불을 잠시 멈췄어요. 사장님께 부탁해 주세요.": "Staff refunds are paused because the exchange rate couldn’t be read. Please ask the owner.",
      "환율을 읽지 못해 직원 환불을 잠시 멈췄습니다. 사장님께 부탁하세요.": "Staff refunds are paused because the exchange rate couldn’t be read. Please ask the owner.",
      "한 번에 최대": "Up to",
      "오늘 남은 한도": "remaining today",
      "(오늘 {0} 나감)": "({0} refunded today)",
      "{0} 환불하기": "Refund {0}",
      "환불하기": "Refund",
      "주소와 금액을 넣어 주세요.": "Enter the address and amount.",
      "{0} ({1} RVN) 돌려줬어요. 오늘 남은 한도 {2} · 사장님께 알림이 갔어요.": "Refunded {0} ({1} RVN). Remaining today: {2}. The owner has been notified.",
      "손님에게 받을 주소를 물어보세요.": "Ask the customer for their receiving address.",
      "체인은 누가 보냈는지 기록하지 않아서 돌려줄 곳을 우리가 알 수 없습니다.": "The chain doesn’t record who sent a payment, so we can’t know where to return it.",
      "손님 주소": "Customer address",
      "사유": "Reason",
      "방금": "just now",
      "{0}분 전": "{0} min ago",
      "{0}시간 전": "{0} h ago",
      "{0}번 테이블": "Table {0}",
      "주문번호 {0}": "Order no. {0}",
      "{0} 기준 · {1}건": "As of {0} · {1} orders",
      "새 주문": "New order",
      "나옴": "Ready",
      "확인 필요": "Needs checking",
      "만들기 시작": "Start preparing",
      "나왔다고 알리기": "Mark as ready",
      "전달 완료": "Handed over",
      "조용하네요": "All quiet",
      "손님이 QR로 주문하면": "When a customer orders by QR,",
      "번호표가 여기 뜹니다.": "the order ticket shows up here.",
      "환불 절차든 회원 확인이든 물어보세요.": "Ask about refunds, member checks, anything.",
      "손님이 읽고 동의하면 아래를 눌러 주세요.": "Once the customer has read and agreed, tap below.",
      /* 직원 폰 「회원」 탭 (2026-09-23) */
      "주문": "Orders",
      "회원": "Members",
      "환불": "Refund",
      "다니는 중": "Active",
      ...
      "다음 손님": "Next customer",
      "회원 보기": "View member",
      "이름 · 번호 · 전화 끝 4자리": "Name · number · last 4 phone digits",
      "표 번호를 적어 주세요": "Enter the ticket number",
      "손님 폰의 표 화면에 적힌 번호예요.": "It’s the number shown on the customer’s ticket screen.",
      "표 번호": "Ticket number",
      "예: K7P2QM4X": "e.g. K7P2QM4X",
      "손님 정보": "Customer details",
      "이름": "Name",
      "전화 끝 4자리": "Last 4 phone digits",
      "전화번호": "Phone number",
      "분류 (안 골라도 돼요)": "Groups (optional)",
      "메모 (안 적어도 돼요)": "Memo (optional)",
      "건강 상태 같은 민감한 정보는 적지 마세요.": "Don’t write sensitive information such as health conditions.",
      "손님께 보여 주세요": "Show this to the customer",
      "손님이 위 내용에 동의했어요": "The customer agreed to the above",
      "회원으로 등록했어요": "Registered as a member",
      "이미 회원으로 등록돼 있어요": "Already registered as a member",
      "주문을 넘기고, 회원을 찾고 등록하고,": "Pass orders along, find and register members,",
      "이 화면에서는": "On this screen",
      "지갑도 설정도 볼 수 없습니다.": "you cannot see the wallet or settings.",
      "한도 안에서 환불": "refund within the limit",
      "만 됩니다.": "— that’s all.",
      "{0}까지": "until {0}",
      "끝나는 날이 없어요": "No end date",
      "{0}회 남음": "{0} visits left",
      "사장님": "Owner",
      "직원": "Staff",
      "문 앞": "Door",
      "가게 컴퓨터에 닿지 못했어요": "Couldn’t reach the shop computer",
      "폰이 가게 와이파이에 연결됐는지 확인해 주세요.": "Check that this phone is on the shop’s Wi‑Fi.",
      "가게 안에서만 열려요": "Only opens inside the shop",
      "가게 와이파이에 연결한 뒤 다시 열어 주세요.": "Connect to the shop’s Wi‑Fi and open it again.",
      "연결이 풀렸어요": "This phone was disconnected",
      "가게 컴퓨터의 「직원 QR」을 폰 카메라로 다시 찍어 주세요.": "Scan the “Staff QR” on the shop computer again with your phone camera.",
      "이 가게는 회원 정보를 받지 않아요": "This shop doesn’t collect member information",
      "사장님이 가게 컴퓨터에서 바꿀 수 있어요.": "The owner can change this on the shop computer.",
      "가게 컴퓨터의 회원 설정을 읽지 못했어요": "Couldn’t read the member settings on the shop computer",
      "사장님께 가게 컴퓨터를 확인해 달라고 말씀해 주세요.": "Please ask the owner to check the shop computer.",
      "가게 앱을 최신으로 올려 주세요": "Please update the shop app",
      "가게 컴퓨터의 RavenVault Desktop 을 업데이트하면 회원 기능이 열려요.": "Update RavenVault Desktop on the shop computer to turn on member features.",
      "모든 분류": "All groups",
      "두 글자 이상 쳐 주세요. 전화는 끝 4자리예요.": "Type at least 2 characters. For phones, use the last 4 digits.",
      "찾지 못했어요": "Nothing found",
      "검색어를 바꿔 다시 해 보세요.": "Try different search words.",
      "‘{0}’ 회원이 없어요": "No member matches ‘{0}’",
      "표를 산 손님이면 새 회원으로 등록해 주세요.": "If they bought a ticket, register them as a new member.",
      "{0} 회원이 없어요": "No members: {0}",
      "다른 분류를 골라 보세요.": "Try another group.",
      "표를 산 손님을 회원으로 등록해 보세요.": "Register customers who bought tickets as members.",
      "30명까지 보여요. 이름을 더 쳐 보세요.": "Showing up to 30. Type more of the name.",
      "홈 화면에 추가하면 앱처럼 열려요": "Add to Home Screen to open it like an app",
      "아래 공유 단추(□↑)를 누르고 「홈 화면에 추가」를 고르세요.": "Tap the Share button (□↑) below and choose “Add to Home Screen”.",
      "회원으로 등록하기": "Register as a member",
      "아직 회원이 아닌 표예요": "This ticket isn’t a member yet",
      "손님 동의를 받고 회원으로 등록할 수 있어요.": "With the customer’s consent, you can register them as a member.",
      "회원 정보를 불러오지 못했어요": "Couldn’t load member information",
      "잠시 뒤 다시 열어 주세요.": "Please open it again in a moment.",
      "지워진 회원": "Deleted member",
      "보관 기간이 지나 정보가 지워진 회원이에요": "This member’s information was deleted after the retention period",
      "회원번호와 출입 기록만 남아 있어요.": "Only the member number and visit history remain.",
      "회원번호 {0}": "Member no. {0}",
      "분류": "Groups",
      "사장님이 가게 컴퓨터에서 분류를 만들면 여기서 고를 수 있어요.": "Once the owner creates groups on the shop computer, you can pick them here.",
      "메모": "Memo",
      "메모 추가": "Add a memo",
      "적기": "Add",
      "아직 메모가 없어요.": "No memos yet.",
      "분류는 한 사람에 5개까지 고를 수 있어요": "You can pick up to 5 groups per person",
      "저장했어요": "Saved",
      "분류가 바뀌었어요. 다시 골라 주세요.": "The groups have changed. Please pick again.",
      "저장하지 못했어요": "Couldn’t save",
      "적혔는지 확인하지 못했어요. 다시 불러와서 확인해 주세요.": "Couldn’t confirm it was saved. Reload and check.",
      "다시 불러오기": "Reload",
      "메모를 적었어요": "Memo added",
      "메모가 너무 많아요. 사장님이 가게 컴퓨터에서 정리해 주세요.": "There are too many memos. Ask the owner to tidy them up on the shop computer.",
      "메모는 300자까지 한 줄로 적어 주세요.": "Write the memo on one line, up to 300 characters.",
      "메모를 적지 못했어요": "Couldn’t add the memo",
      "등록하는 중…": "Registering…",
      "다시 보내기": "Send again",
      "등록하기": "Register",
      "이름만 받아요.": "We collect the name only.",
      "이름과 전화 끝 4자리를 받아요.": "We collect the name and last 4 phone digits.",
      "이름과 전화번호를 받아요.": "We collect the name and phone number.",
      "받은 정보는 이용이 끝나고 {0}개월 뒤 저절로 지워져요.": "This information is deleted automatically {0} months after use ends.",
      "확인하는 중…": "Checking…",
      "이용권": "Pass",
      "이미 회원으로 등록된 표예요.": "This ticket is already registered as a member.",
      "그런 표가 없어요. 번호를 다시 확인해 주세요.": "No such ticket. Please check the number.",
      "등록됐는지 확인하지 못했어요. 와이파이를 확인하고 다시 보내 주세요.": "Couldn’t confirm the registration. Check the Wi‑Fi and send again.",
      "받는 정보가 바뀌었어요. 다시 적어 주세요.": "The information collected has changed. Please enter it again.",
      "동의 내용이 바뀌었어요. 손님께 다시 보여 주세요.": "The consent text has changed. Please show it to the customer again.",
      "등록하지 못했어요. 잠시 뒤 다시 해 주세요.": "Couldn’t register. Please try again in a moment.",
      "이름을 적어 주세요.": "Please enter the name.",
      "그런 표가 없습니다.": "No such ticket.",
      "이미 회원으로 등록된 표입니다.": "This ticket is already registered as a member.",
      "분류 관리": "Manage groups",
    ...
    "마지막 자동 정리: {0} · {1}명 정리": "Last automatic cleanup: {0} · {1} members redacted",
    "아직 자동 정리를 하지 않았어요": "Automatic cleanup has not run yet",
    "마지막 자동 정리가 실패했어요: {0} 하루 뒤 다시 시도해요.": "The last automatic cleanup failed: {0} We will try again in one day.",
    "회원 정보 설정 파일이 손상되었어요. 설정을 다시 저장해 주세요.": "The member information settings file is damaged. Please save the settings again.",
    "회원 정보 설정 파일이 손상되었습니다.": "The member information settings file is damaged.",
    "회원 장부를 읽지 못했습니다.": "Could not read the member ledger.",
    "정리 중 오류가 났습니다.": "An error occurred during cleanup.",
    "이 가게 컴퓨터와 그 백업에": "on this shop's computer and its backups",
    "명단은 이 가게 컴퓨터와 그 백업에 저장됩니다. 다른 기기에서는 다시 보입니다.": "The list is stored on this shop's computer and its backups. People hidden here will appear again on other devices.",
      "문 앞에서 회원으로 등록할 때 받는 정보를 정합니다.": "Choose what to collect when registering members at the door.",
      "회원 정보 받기": "Collect member information",
      "회원 정보 보관": "Member information retention",
      "이름만": "Name only",
      "이름+전화 뒷자리 4자리": "Name + last 4 phone digits",
      "이름+전화 전체": "Name + full phone number",
      "12개월": "12 months",
      "회원 정보 설정 저장": "Save member information settings",
      "회원 정보 설정을 읽지 못했습니다.": "Could not load member information settings.",
      "회원 정보 설정을 저장했습니다.": "Member information settings saved.",
      "회원 정보 설정을 저장하지 못했습니다.": "Could not save member information settings.",
      "회원 한 명 지금 지우기": "Delete this member now",
      "이 회원의 정보와 출입 기록을 모두 지울까요? 되돌릴 수 없습니다.": "Delete all information and visit history for this member? This cannot be undone.",
      "회원 정보를 지우지 못했습니다.": "Could not delete member information.",
      "회원권과 출입 기록은 남습니다. 보관기간이 지난 개인정보는 자동 삭제됩니다.": "Passes and visit history remain. Personal information is automatically deleted after the retention period.",
      "손님이 동의했어요": "The customer has consented",
      "전화 전체": "Full phone number",
      "전화 뒷자리 4자리": "Last 4 phone digits",
      "이름·전화 뒷자리": "Name and last phone digits",
      "이름·전화": "Name and phone number",
      "이 가게는 회원 정보를 받지 않습니다.": "This shop does not collect member information.",
      "손님의 동의를 확인해 주세요.": "Please confirm the customer’s consent.",
      "이름에는 제어문자를 넣을 수 없습니다.": "Names cannot contain control characters.",
      "전화번호의 숫자를 적어 주세요.": "Enter the phone number digits.",
      "전화번호를 확인해 주세요.": "Check the phone number.",
      /* 열쇠 상태 */
      "내 열쇠가 들어 있습니다":
        "Your own key is saved",
      "바꾸기":
        "Change",
      "지우기":
        "Remove",
      /* 사진 사본 */
      "가게 컴퓨터에서 올리시면 그 컴퓨터에도 한 부 남습니다.":
        "If you upload from the shop computer, a copy stays on that computer too.",
      "이 가게 컴퓨터에도 한 부 보관했습니다.":
        "A copy is also kept on this shop computer.",
      /* 아이콘 칸 */
      "QR 로 받습니다":
        "Receive by QR",
      "주소로 보냅니다":
        "Send to an address",
      "쓰던 주소까지":
        "Including addresses you used",
      "사진 찍어 올리기":
        "Take a photo and post",
      "다시 읽어오기":
        "Read it again",
      "사진 찍어 올리면 끝 · 공짜":
        "Take a photo, post it, done · free",
      /* 빈 화면 — 처음 온 사람이 실제로 보는 것 */
      "이 동네의 첫 가게를 찾고 있습니다":
        "Looking for this neighbourhood's first shop",
      "아직 아무도 없습니다. 지금 여시면":
        "Nobody yet. Open now and you become",
      "1호":
        "the first",
      "가 됩니다.":
        ".",
      "레이븐코인을 받는 가게라면 누구나 올릴 수 있어요.":
        "Any shop that accepts Ravencoin can list here.",
      /* 장터·랜딩(2026-08-22) */
    ...
    ja: {
      "주문 취소": "注文キャンセル",
      /* 직원 화면 주문·환불 (2026-09-23) */
      "환율을 읽지 못해 직원 환불을 잠시 멈췄어요. 사장님께 부탁해 주세요.": "為替レートを読み込めないため、スタッフの返金を一時停止しています。店長にお願いしてください。",
      "환율을 읽지 못해 직원 환불을 잠시 멈췄습니다. 사장님께 부탁하세요.": "為替レートを読み込めないため、スタッフの返金を一時停止しています。店長にお願いしてください。",
      "한 번에 최대": "1回あたり最大",
      "오늘 남은 한도": "今日の残り上限",
      "(오늘 {0} 나감)": "(今日 {0} 返金済み)",
      "{0} 환불하기": "{0} を返金",
      "환불하기": "返金する",
      "주소와 금액을 넣어 주세요.": "アドレスと金額を入力してください。",
      "{0} ({1} RVN) 돌려줬어요. 오늘 남은 한도 {2} · 사장님께 알림이 갔어요.": "{0}（{1} RVN）を返金しました。今日の残り上限 {2}・店長に通知しました。",
      "손님에게 받을 주소를 물어보세요.": "お客様に受け取りアドレスを聞いてください。",
      "체인은 누가 보냈는지 기록하지 않아서 돌려줄 곳을 우리가 알 수 없습니다.": "チェーンは送り主を記録しないため、返金先を私たちは知ることができません。",
      "손님 주소": "お客様のアドレス",
      "사유": "理由",
      "방금": "たった今",
      "{0}분 전": "{0}分前",
      ...
      "전달 완료": "受け渡し完了",
      "조용하네요": "静かですね",
      "손님이 QR로 주문하면": "お客様がQRで注文すると",
      "번호표가 여기 뜹니다.": "番号札がここに表示されます。",
      "환불 절차든 회원 확인이든 물어보세요.": "返金の手順でも会員確認でも聞いてください。",
      "손님이 읽고 동의하면 아래를 눌러 주세요.": "お客様が読んで同意したら、下を押してください。",
      /* 직원 폰 「회원」 탭 (2026-09-23) */
      "주문": "注文",
      "회원": "会員",
      "환불": "返金",
      ...
      "다음 손님": "次のお客様",
      "회원 보기": "会員を見る",
      "이름 · 번호 · 전화 끝 4자리": "名前・番号・電話の下4桁",
      "표 번호를 적어 주세요": "チケット番号を入力してください",
      "손님 폰의 표 화면에 적힌 번호예요.": "お客様のスマホのチケット画面に書かれた番号です。",
      "표 번호": "チケット番号",
      "예: K7P2QM4X": "例: K7P2QM4X",
      "손님 정보": "お客様の情報",
      "이름": "名前",
      "전화 끝 4자리": "電話の下4桁",
      "전화번호": "電話番号",
      "분류 (안 골라도 돼요)": "分類(選ばなくても大丈夫)",
      "메모 (안 적어도 돼요)": "メモ(書かなくても大丈夫)",
      "건강 상태 같은 민감한 정보는 적지 마세요.": "健康状態のような個人的に敏感な情報は書かないでください。",
      "손님께 보여 주세요": "お客様に見せてください",
      "손님이 위 내용에 동의했어요": "お客様が上の内容に同意しました",
      "회원으로 등록했어요": "会員として登録しました",
      "이미 회원으로 등록돼 있어요": "すでに会員として登録されています",
      "주문을 넘기고, 회원을 찾고 등록하고,": "注文を進め、会員を探して登録し、",
      "이 화면에서는": "この画面では",
      "지갑도 설정도 볼 수 없습니다.": "ウォレットも設定も見られません。",
      "한도 안에서 환불": "上限内での返金",
      "만 됩니다.": "だけができます。",
      "{0}까지": "{0}まで",
      "끝나는 날이 없어요": "終了日はありません",
      "{0}회 남음": "残り{0}回",
      "사장님": "店長",
      "직원": "スタッフ",
      "문 앞": "入口",
      "가게 컴퓨터에 닿지 못했어요": "お店のパソコンにつながりません",
      "폰이 가게 와이파이에 연결됐는지 확인해 주세요.": "スマホがお店のWi‑Fiにつながっているか確認してください。",
      "가게 안에서만 열려요": "お店の中でだけ開きます",
      "가게 와이파이에 연결한 뒤 다시 열어 주세요.": "お店のWi‑Fiにつないでから、もう一度開いてください。",
      "연결이 풀렸어요": "接続が切れました",
      "가게 컴퓨터의 「직원 QR」을 폰 카메라로 다시 찍어 주세요.": "お店のパソコンの「スタッフQR」をスマホのカメラでもう一度読み取ってください。",
      "이 가게는 회원 정보를 받지 않아요": "このお店は会員情報を受け付けていません",
      "사장님이 가게 컴퓨터에서 바꿀 수 있어요.": "店長がお店のパソコンで変更できます。",
      "가게 컴퓨터의 회원 설정을 읽지 못했어요": "お店のパソコンの会員設定を読み込めませんでした",
      "사장님께 가게 컴퓨터를 확인해 달라고 말씀해 주세요.": "店長にお店のパソコンを確認してもらってください。",
      "가게 앱을 최신으로 올려 주세요": "お店のアプリを最新にしてください",
      "가게 컴퓨터의 RavenVault Desktop 을 업데이트하면 회원 기능이 열려요.": "お店のパソコンの RavenVault Desktop を更新すると会員機能が使えます。",
      "모든 분류": "すべての分類",
      "두 글자 이상 쳐 주세요. 전화는 끝 4자리예요.": "2文字以上入力してください。電話は下4桁です。",
      "찾지 못했어요": "見つかりませんでした",
      "검색어를 바꿔 다시 해 보세요.": "別の言葉で探してみてください。",
      "‘{0}’ 회원이 없어요": "「{0}」の会員はいません",
      "표를 산 손님이면 새 회원으로 등록해 주세요.": "チケットを買ったお客様なら、新しい会員として登録してください。",
      "{0} 회원이 없어요": "{0}の会員はいません",
      "다른 분류를 골라 보세요.": "別の分類を選んでみてください。",
      "표를 산 손님을 회원으로 등록해 보세요.": "チケットを買ったお客様を会員として登録してみてください。",
      "30명까지 보여요. 이름을 더 쳐 보세요.": "30人まで表示します。名前をもう少し入力してください。",
      "홈 화면에 추가하면 앱처럼 열려요": "ホーム画面に追加するとアプリのように開けます",
      "아래 공유 단추(□↑)를 누르고 「홈 화면에 추가」를 고르세요.": "下の共有ボタン(□↑)を押して「ホーム画面に追加」を選んでください。",
      "회원으로 등록하기": "会員として登録する",
      "아직 회원이 아닌 표예요": "まだ会員ではないチケットです",
      "손님 동의를 받고 회원으로 등록할 수 있어요.": "お客様の同意を得て会員登録できます。",
      "회원 정보를 불러오지 못했어요": "会員情報を読み込めませんでした",
      "잠시 뒤 다시 열어 주세요.": "少ししてからもう一度開いてください。",
      "지워진 회원": "削除された会員",
      "보관 기간이 지나 정보가 지워진 회원이에요": "保管期間が過ぎて情報が削除された会員です",
      "회원번호와 출입 기록만 남아 있어요.": "会員番号と入退場の記録だけが残っています。",
      "회원번호 {0}": "会員番号 {0}",
      "분류": "分類",
      "사장님이 가게 컴퓨터에서 분류를 만들면 여기서 고를 수 있어요.": "店長がお店のパソコンで分類を作ると、ここで選べます。",
      "메모": "メモ",
      "메모 추가": "メモを追加",
      "적기": "書く",
      "아직 메모가 없어요.": "まだメモはありません。",
      "분류는 한 사람에 5개까지 고를 수 있어요": "分類は1人5つまで選べます",
      "저장했어요": "保存しました",
      "분류가 바뀌었어요. 다시 골라 주세요.": "分類が変わりました。もう一度選んでください。",
      "저장하지 못했어요": "保存できませんでした",
      "적혔는지 확인하지 못했어요. 다시 불러와서 확인해 주세요.": "書き込まれたか確認できませんでした。読み込み直して確認してください。",
      "다시 불러오기": "読み込み直す",
      "메모를 적었어요": "メモを書きました",
      "메모가 너무 많아요. 사장님이 가게 컴퓨터에서 정리해 주세요.": "メモが多すぎます。店長にお店のパソコンで整理してもらってください。",
      "메모는 300자까지 한 줄로 적어 주세요.": "メモは300文字まで1行で書いてください。",
      "메모를 적지 못했어요": "メモを書けませんでした",
      "등록하는 중…": "登録中…",
      "다시 보내기": "もう一度送る",
      "등록하기": "登録する",
      "이름만 받아요.": "名前だけを受け付けます。",
      "이름과 전화 끝 4자리를 받아요.": "名前と電話の下4桁を受け付けます。",
      "이름과 전화번호를 받아요.": "名前と電話番号を受け付けます。",
      "받은 정보는 이용이 끝나고 {0}개월 뒤 저절로 지워져요.": "受け取った情報は利用終了の{0}か月後に自動で削除されます。",
      "확인하는 중…": "確認中…",
      "이용권": "利用券",
      "이미 회원으로 등록된 표예요.": "すでに会員登録されたチケットです。",
      "그런 표가 없어요. 번호를 다시 확인해 주세요.": "そのチケットはありません。番号をもう一度確認してください。",
      "등록됐는지 확인하지 못했어요. 와이파이를 확인하고 다시 보내 주세요.": "登録されたか確認できませんでした。Wi‑Fiを確認してもう一度送ってください。",
      "받는 정보가 바뀌었어요. 다시 적어 주세요.": "受け付ける情報が変わりました。もう一度入力してください。",
      "동의 내용이 바뀌었어요. 손님께 다시 보여 주세요.": "同意内容が変わりました。お客様にもう一度見せてください。",
      "등록하지 못했어요. 잠시 뒤 다시 해 주세요.": "登録できませんでした。少ししてからもう一度お試しください。",
      "이름을 적어 주세요.": "名前を入力してください。",
      "그런 표가 없습니다.": "そのチケットはありません。",
      "이미 회원으로 등록된 표입니다.": "すでに会員登録されたチケットです。",
      "분류 관리": "分類の管理",
    ...
    "마지막 자동 정리: {0} · {1}명 정리": "前回の自動削除：{0} · {1}人の情報を削除",
    "아직 자동 정리를 하지 않았어요": "自動削除はまだ実行されていません",
    "마지막 자동 정리가 실패했어요: {0} 하루 뒤 다시 시도해요.": "前回の自動削除に失敗しました：{0} 1日後に再試行します。",
    "회원 정보 설정 파일이 손상되었어요. 설정을 다시 저장해 주세요.": "会員情報の設定ファイルが破損しています。設定を保存し直してください。",
    "회원 정보 설정 파일이 손상되었습니다.": "会員情報の設定ファイルが破損しています。",
    "회원 장부를 읽지 못했습니다.": "会員台帳を読み込めませんでした。",
    "정리 중 오류가 났습니다.": "削除中にエラーが発生しました。",
    "이 가게 컴퓨터와 그 백업에": "この店のコンピューターとそのバックアップに",
    "명단은 이 가게 컴퓨터와 그 백업에 저장됩니다. 다른 기기에서는 다시 보입니다.": "リストはこの店のコンピューターとそのバックアップに保存されます。他の端末では再び表示されます。",
      "문 앞에서 회원으로 등록할 때 받는 정보를 정합니다.": "入口で会員登録する際に収集する情報を設定します。",
      "회원 정보 받기": "会員情報の収集",
      "회원 정보 보관": "会員情報の保存期間",
      "이름만": "名前のみ",
      "이름+전화 뒷자리 4자리": "名前＋電話番号の下4桁",
      "이름+전화 전체": "名前＋電話番号全体",
      "12개월": "12か月",
      "회원 정보 설정 저장": "会員情報の設定を保存",
      "회원 정보 설정을 읽지 못했습니다.": "会員情報の設定を読み込めませんでした。",
      "회원 정보 설정을 저장했습니다.": "会員情報の設定を保存しました。",
      "회원 정보 설정을 저장하지 못했습니다.": "会員情報の設定を保存できませんでした。",
      "회원 한 명 지금 지우기": "この会員を今すぐ削除",
      "이 회원의 정보와 출입 기록을 모두 지울까요? 되돌릴 수 없습니다.": "この会員の情報と入退場履歴をすべて削除しますか？元に戻せません。",
      "회원 정보를 지우지 못했습니다.": "会員情報を削除できませんでした。",
      "회원권과 출입 기록은 남습니다. 보관기간이 지난 개인정보는 자동 삭제됩니다.": "会員券と入退場履歴は残ります。保存期間を過ぎた個人情報は自動削除されます。",
      "손님이 동의했어요": "お客様の同意を確認しました",
      "전화 전체": "電話番号全体",
      "전화 뒷자리 4자리": "電話番号の下4桁",
      "이름·전화 뒷자리": "名前・電話番号の下4桁",
      "이름·전화": "名前・電話番号",
      "이 가게는 회원 정보를 받지 않습니다.": "この店舗では会員情報を収集しません。",
      "손님의 동의를 확인해 주세요.": "お客様の同意を確認してください。",
      "이름에는 제어문자를 넣을 수 없습니다.": "名前に制御文字は使用できません。",
      "전화번호의 숫자를 적어 주세요.": "電話番号の数字を入力してください。",
      "전화번호를 확인해 주세요.": "電話番号を確認してください。",
      /* 열쇠 상태 */
      "내 열쇠가 들어 있습니다":
        "自分のキーが入っています",
      "바꾸기":
      ...
      /* 사진 사본 */
      "가게 컴퓨터에서 올리시면 그 컴퓨터에도 한 부 남습니다.":
        "お店のパソコンからアップロードすると、そのパソコンにも一部残ります。",
      "이 가게 컴퓨터에도 한 부 보관했습니다.":
        "このお店のパソコンにも一部保管しました。",
      /* 아이콘 칸 */
      "QR 로 받습니다":
    ...
    zh: {
      "주문 취소": "取消订单",
      /* 직원 화면 주문·환불 (2026-09-23) */
      "환율을 읽지 못해 직원 환불을 잠시 멈췄어요. 사장님께 부탁해 주세요.": "无法读取汇率，店员退款已暂停。请找店主处理。",
      "환율을 읽지 못해 직원 환불을 잠시 멈췄습니다. 사장님께 부탁하세요.": "无法读取汇率，店员退款已暂停。请找店主处理。",
      "한 번에 최대": "单次最多",
      "오늘 남은 한도": "今日剩余额度",
      "(오늘 {0} 나감)": "（今日已退 {0}）",
      "{0} 환불하기": "退款 {0}",
      "환불하기": "退款",
      "주소와 금액을 넣어 주세요.": "请输入地址和金额。",
      "{0} ({1} RVN) 돌려줬어요. 오늘 남은 한도 {2} · 사장님께 알림이 갔어요.": "已退款 {0}（{1} RVN）。今日剩余额度 {2}，已通知店主。",
      "손님에게 받을 주소를 물어보세요.": "请向顾客询问收款地址。",
      "체인은 누가 보냈는지 기록하지 않아서 돌려줄 곳을 우리가 알 수 없습니다.": "区块链不记录付款人，所以我们无法知道该退到哪里。",
      "손님 주소": "顾客地址",
      "사유": "原因",
      "방금": "刚刚",
      "{0}분 전": "{0}分钟前",
      ...
      "전달 완료": "已交付",
      "조용하네요": "现在很安静",
      "손님이 QR로 주문하면": "顾客扫码点单后，",
      "번호표가 여기 뜹니다.": "号码牌会显示在这里。",
      "환불 절차든 회원 확인이든 물어보세요.": "退款流程、会员确认都可以问。",
      "손님이 읽고 동의하면 아래를 눌러 주세요.": "顾客阅读并同意后，请点下方。",
      /* 직원 폰 「회원」 탭 (2026-09-23) */
      "주문": "订单",
      "회원": "会员",
      "환불": "退款",
      ...
      "다음 손님": "下一位顾客",
      "회원 보기": "查看会员",
      "이름 · 번호 · 전화 끝 4자리": "姓名 · 编号 · 电话后4位",
      "표 번호를 적어 주세요": "请输入票号",
      "손님 폰의 표 화면에 적힌 번호예요.": "就是顾客手机票券画面上的号码。",
      "표 번호": "票号",
      "예: K7P2QM4X": "例：K7P2QM4X",
      "손님 정보": "顾客信息",
      "이름": "姓名",
      ...
      "분류 (안 골라도 돼요)": "分类（可不选）",
      "메모 (안 적어도 돼요)": "备注（可不填）",
      "건강 상태 같은 민감한 정보는 적지 마세요.": "请勿填写健康状况等敏感信息。",
      "손님께 보여 주세요": "请给顾客看",
      "손님이 위 내용에 동의했어요": "顾客已同意以上内容",
      "회원으로 등록했어요": "已登记为会员",
      "이미 회원으로 등록돼 있어요": "已经登记为会员",
      "주문을 넘기고, 회원을 찾고 등록하고,": "处理订单、查找和登记会员，",
      "이 화면에서는": "在此画面",
      "지갑도 설정도 볼 수 없습니다.": "无法查看钱包和设置。",
      "한도 안에서 환불": "在限额内退款",
      "만 됩니다.": "仅此而已。",
      "{0}까지": "至 {0}",
      "끝나는 날이 없어요": "没有到期日",
      ...
      "직원": "店员",
      "문 앞": "门口",
      "가게 컴퓨터에 닿지 못했어요": "连接不到店里的电脑",
      "폰이 가게 와이파이에 연결됐는지 확인해 주세요.": "请确认手机已连接店里的 Wi‑Fi。",
      "가게 안에서만 열려요": "只能在店内打开",
      "가게 와이파이에 연결한 뒤 다시 열어 주세요.": "请连接店里的 Wi‑Fi 后再打开。",
      "연결이 풀렸어요": "连接已断开",
      "가게 컴퓨터의 「직원 QR」을 폰 카메라로 다시 찍어 주세요.": "请用手机相机重新扫描店里电脑上的「店员二维码」。",
      "이 가게는 회원 정보를 받지 않아요": "本店不收集会员信息",
      "사장님이 가게 컴퓨터에서 바꿀 수 있어요.": "店主可以在店里的电脑上更改。",
      "가게 컴퓨터의 회원 설정을 읽지 못했어요": "无法读取店里电脑上的会员设置",
      "사장님께 가게 컴퓨터를 확인해 달라고 말씀해 주세요.": "请让店主检查店里的电脑。",
      "가게 앱을 최신으로 올려 주세요": "请将店铺应用更新到最新版",
      "가게 컴퓨터의 RavenVault Desktop 을 업데이트하면 회원 기능이 열려요.": "更新店里电脑上的 RavenVault Desktop 后即可使用会员功能。",
      "모든 분류": "全部分类",
      "두 글자 이상 쳐 주세요. 전화는 끝 4자리예요.": "请输入至少2个字。电话请输入后4位。",
      "찾지 못했어요": "没有找到",
      "검색어를 바꿔 다시 해 보세요.": "请换个关键词再试。",
      "‘{0}’ 회원이 없어요": "没有「{0}」这位会员",
      "표를 산 손님이면 새 회원으로 등록해 주세요.": "如果顾客已购票，请登记为新会员。",
      "{0} 회원이 없어요": "没有{0}的会员",
      "다른 분류를 골라 보세요.": "请选择其他分类。",
      "표를 산 손님을 회원으로 등록해 보세요.": "把已购票的顾客登记为会员吧。",
      "30명까지 보여요. 이름을 더 쳐 보세요.": "最多显示30人。请多输入一些姓名。",
      "홈 화면에 추가하면 앱처럼 열려요": "添加到主屏幕后可像应用一样打开",
      "아래 공유 단추(□↑)를 누르고 「홈 화면에 추가」를 고르세요.": "点下方的分享按钮（□↑），选择「添加到主屏幕」。",
      "회원으로 등록하기": "登记为会员",
      "아직 회원이 아닌 표예요": "这张票还不是会员",
      "손님 동의를 받고 회원으로 등록할 수 있어요.": "征得顾客同意后即可登记为会员。",
      "회원 정보를 불러오지 못했어요": "无法加载会员信息",
      "잠시 뒤 다시 열어 주세요.": "请稍后再打开。",
      "지워진 회원": "已删除的会员",
      "보관 기간이 지나 정보가 지워진 회원이에요": "保存期限已过，该会员的信息已删除",
      "회원번호와 출입 기록만 남아 있어요.": "只保留会员编号和出入记录。",
      "회원번호 {0}": "会员编号 {0}",
      "분류": "分类",
      "사장님이 가게 컴퓨터에서 분류를 만들면 여기서 고를 수 있어요.": "店主在店里电脑上创建分类后，这里就能选择。",
      "메모": "备注",
      "메모 추가": "添加备注",
      "적기": "添加",
      "아직 메모가 없어요.": "还没有备注。",
      "분류는 한 사람에 5개까지 고를 수 있어요": "每人最多可选5个分类",
      "저장했어요": "已保存",
      "분류가 바뀌었어요. 다시 골라 주세요.": "分类已更改，请重新选择。",
      "저장하지 못했어요": "未能保存",
      "적혔는지 확인하지 못했어요. 다시 불러와서 확인해 주세요.": "无法确认是否已写入。请重新加载确认。",
      "다시 불러오기": "重新加载",
      "메모를 적었어요": "已添加备注",
      "메모가 너무 많아요. 사장님이 가게 컴퓨터에서 정리해 주세요.": "备注太多了。请店主在店里电脑上整理。",
      "메모는 300자까지 한 줄로 적어 주세요.": "备注请写在一行内，最多300字。",
      "메모를 적지 못했어요": "未能添加备注",
      "등록하는 중…": "登记中…",
      "다시 보내기": "重新发送",
      "등록하기": "登记",
      "이름만 받아요.": "只收集姓名。",
      "이름과 전화 끝 4자리를 받아요.": "收集姓名和电话后4位。",
      "이름과 전화번호를 받아요.": "收集姓名和电话号码。",
      "받은 정보는 이용이 끝나고 {0}개월 뒤 저절로 지워져요.": "所收集的信息将在使用结束{0}个月后自动删除。",
      "확인하는 중…": "正在确认…",
      "이용권": "使用券",
      "이미 회원으로 등록된 표예요.": "这张票已经登记为会员。",
      "그런 표가 없어요. 번호를 다시 확인해 주세요.": "没有这张票。请再核对号码。",
      "등록됐는지 확인하지 못했어요. 와이파이를 확인하고 다시 보내 주세요.": "无法确认是否已登记。请检查 Wi‑Fi 后重新发送。",
      "받는 정보가 바뀌었어요. 다시 적어 주세요.": "收集的信息已更改，请重新填写。",
      "동의 내용이 바뀌었어요. 손님께 다시 보여 주세요.": "同意内容已更改，请重新给顾客看。",
      "등록하지 못했어요. 잠시 뒤 다시 해 주세요.": "未能登记。请稍后再试。",
      "이름을 적어 주세요.": "请输入姓名。",
      "그런 표가 없습니다.": "没有这张票。",
      "이미 회원으로 등록된 표입니다.": "这张票已经登记为会员。",
      "분류 관리": "管理分类",
    ...
    "마지막 자동 정리: {0} · {1}명 정리": "上次自动清理：{0} · 已清理{1}位会员的信息",
    "아직 자동 정리를 하지 않았어요": "尚未执行自动清理",
    "마지막 자동 정리가 실패했어요: {0} 하루 뒤 다시 시도해요.": "上次自动清理失败：{0} 将在一天后重试。",
    "회원 정보 설정 파일이 손상되었어요. 설정을 다시 저장해 주세요.": "会员信息设置文件已损坏。请重新保存设置。",
    "회원 정보 설정 파일이 손상되었습니다.": "会员信息设置文件已损坏。",
    "회원 장부를 읽지 못했습니다.": "无法读取会员账簿。",
    "정리 중 오류가 났습니다.": "清理时发生错误。",
    "이 가게 컴퓨터와 그 백업에": "在本店电脑及其备份中",
    "명단은 이 가게 컴퓨터와 그 백업에 저장됩니다. 다른 기기에서는 다시 보입니다.": "名单保存在本店电脑及其备份中。在其他设备上仍会显示。",
      "문 앞에서 회원으로 등록할 때 받는 정보를 정합니다.": "设置在门口登记会员时收集的信息。",
      "회원 정보 받기": "收集会员信息",
      "회원 정보 보관": "会员信息保留期限",
      "이름만": "仅姓名",
      "이름+전화 뒷자리 4자리": "姓名＋电话号码后4位",
      "이름+전화 전체": "姓名＋完整电话号码",
      "12개월": "12个月",
      "회원 정보 설정 저장": "保存会员信息设置",
      "회원 정보 설정을 읽지 못했습니다.": "无法读取会员信息设置。",
      "회원 정보 설정을 저장했습니다.": "已保存会员信息设置。",
      "회원 정보 설정을 저장하지 못했습니다.": "无法保存会员信息设置。",
      "회원 한 명 지금 지우기": "立即删除此会员",
      "이 회원의 정보와 출입 기록을 모두 지울까요? 되돌릴 수 없습니다.": "删除此会员的全部信息和出入记录？此操作无法撤销。",
      "회원 정보를 지우지 못했습니다.": "无法删除会员信息。",
      "회원권과 출입 기록은 남습니다. 보관기간이 지난 개인정보는 자동 삭제됩니다.": "保留会员卡和出入记录。超过保留期限的个人信息会自动删除。",
      "손님이 동의했어요": "顾客已同意",
      "전화 전체": "完整电话号码",
      "전화 뒷자리 4자리": "电话号码后4位",
      "이름·전화 뒷자리": "姓名及电话号码后4位",
      "이름·전화": "姓名及电话",
      "이 가게는 회원 정보를 받지 않습니다.": "本店不收集会员信息。",
      "손님의 동의를 확인해 주세요.": "请确认顾客同意。",
      "이름에는 제어문자를 넣을 수 없습니다.": "姓名不能包含控制字符。",
      "전화번호의 숫자를 적어 주세요.": "请输入电话号码的数字。",
      "전화번호를 확인해 주세요.": "请检查电话号码。",
      /* 열쇠 상태 */
      "내 열쇠가 들어 있습니다":
        "已保存您自己的密钥",
      "바꾸기":
