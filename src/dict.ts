...
export const DICT: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    "문 앞": "Door",
    "지우기": "Delete",
    "이 메모를 지울까요?": "Delete this memo?",
    "메모를 저장하지 못했습니다.": "Could not save the memo.",
    "메모는 1~300자 한 줄로 적어 주세요.": "Write a single-line memo of 1–300 characters.",
    "메모는 한 회원에 50개까지 적을 수 있습니다.": "You can add up to 50 memos per member.",
    "아직 메모가 없습니다": "No memos yet",
    "메모가 바뀌었습니다. 다시 열어 주세요.": "The memos have changed. Please reopen the member.",
    ...
    "위의 것을 전부 하면서, 손님 QR·메뉴판·결제·기간권·회원까지 씁니다. 가게가 없어도 괜찮습니다 — 만드는 것부터 같이 합니다.":
      "Everything above, plus customer QR, menu, payments, passes and members. No shop yet? We'll set one up together.",
    "돕는 중":
      "Helping",
    "이 프로그램을 무엇으로 쓰시나요":
    ...
    "하고 있습니다":
      "Running",
    "켜 두는 것만으로 이 그물이 촘촘해집니다. 가게가 늘수록 남의 릴레이가 끊겨도 서로 붙습니다.":
    ...
    "아직 안 받았습니다":
      "Not downloaded yet",
    "손님이 가게 밖에서도 QR 로 들어옵니다.":
      "Customers can scan the QR from outside the shop too.",
    "지금은 같은 와이파이에 있는 손님만 들어옵니다. 밖에서도 받으려면 켜세요.":
      "Right now only customers on the same wifi can get in. Turn this on to take orders from outside too.",
    "컴퓨터를 켜면 저절로 시작":
      "Start automatically when the computer turns on",
    "정전이나 재시작 뒤에도 손님 QR 이 살아 있습니다.":
      "The customer QR stays alive after a power cut or restart.",
    "바깥 연결 끄기":
      "Turn outside access off",
    "준비물 받고 켜기":
    ...
    "한가해지면 알아서 시작하기":
      "Start on its own when business is quiet",
    "지금 시작":
      "Start now",
    "주소 색인":
      "Address index",
    ...
    "넉넉하지는 않습니다":
      "not much room",
    "지금이 한가한 때입니다. 시작하면 좋습니다.":
      "It is quiet right now. A good time to start.",
    "가게 영업시간을 아직 안 받았습니다. 「내 가게」에서 문 여는 시간과 닫는 시간을 적어 주시면, 한가한 때를 골라 알아서 하겠습니다.":
      "We do not have your opening hours yet. Enter your opening and closing times under “My shop” and we will pick a quiet time ourselves.",
    "영업시간을 읽지 못했습니다. 「내 가게」에서 다시 봐 주세요. 아무 때나 시작하지 않겠습니다.":
      "We could not read your opening hours. Please check them under “My shop”. We will not start at a random time.",
    "쉬는 시간이 없는 가게라 한가한 때가 없습니다. 정기 휴무일을 적어 주시거나, 장사에 지장이 없는 때를 골라 「지금 시작」을 눌러 주세요.":
      "This shop never closes, so there is no quiet window. Add a regular day off, or pick a time that will not hurt business and press “Start now”.",
    ...
    /* ── 러스트에서 올라오는 오류 40개 (2026-08-29) ─────────────────
       사장이 겁먹는 그 순간에만 뜨는 말이다. 화면을 걸어서는 못 걷는다.
       노드·지갑·가게·주문·결제·저장에서 자주 나는 것만 골랐다.
       값이 섞인 것(`{}`)은 이 방식으로 못 옮겨서 뺐다. */
    "받는 주소가 올바르지 않습니다.":
      "The recipient address is not valid.",
    "주소가 올바르지 않습니다.":
      "The address is not valid.",
    "올바른 레이븐 주소가 아닙니다.":
      "That is not a valid Ravencoin address.",
    "주소가 비어 있습니다.":
    ...
    "주소 검사값이 맞지 않습니다. 잘못 옮겨 적으신 것 같습니다.":
      "The address checksum does not match. It looks like it was copied down incorrectly.",
    "이 지갑의 주소입니다. 다른 지갑(코어 지갑이나 개인 지갑)의 주소를 넣으세요.":
      "This address belongs to this wallet. Enter an address from another wallet (Core or a personal one).",
    "두 번 입력한 암호가 서로 다릅니다.":
      "The two passwords do not match.",
    "암호는 10자 이상이어야 합니다.":
      "The password must be at least 10 characters.",
    "암호는 10자 이상이어야 합니다. 잊지 않으면서 남이 못 맞출 것으로 정하세요.":
      "The password must be at least 10 characters. Choose one you will not forget but others cannot guess.",
    "새 암호를 두 번 다르게 입력하셨습니다.":
      "The new password was typed differently the second time.",
    "잠금 해제는 10초에서 1시간 사이만 됩니다.":
      "Unlocking is only allowed between 10 seconds and 1 hour.",
    "지갑 암호가 필요합니다.":
      "The wallet password is required.",
    "암호를 확인하지 못했습니다. 다시 해 주세요.":
    ...
    "이 폴더에 wallet.dat 이 없습니다. 레이븐 코어의 데이터 폴더를 골라 주세요.":
      "There is no wallet.dat in this folder. Choose the Ravencoin Core data folder.",
    "그런 폴더가 없습니다.":
      "That folder does not exist.",
    "주소를 받지 못했습니다. 인터넷 연결을 확인해 주세요.":
      "Could not get an address. Please check your internet connection.",
    "가게 이름이 없습니다.":
      "The shop name is missing.",
    "주문 주소는 https:// 여야 합니다.":
      "The order address must start with https://.",
    "결제 금액이 0보다 커야 합니다.":
      "The payment amount must be greater than 0.",
    "이 가게에는 아직 정보가 붙어 있지 않습니다.":
      "This shop has no information attached yet.",
    "수량이 올바르지 않습니다.":
    ...
    "방금 다른 분이 그 시간을 잡았습니다. 다른 시간을 골라 주세요.":
      "Someone else just took that time. Please choose another one.",
    "지난 시각은 예약할 수 없습니다.":
      "You cannot book a time in the past.",
    "환불 금액이 0보다 커야 합니다.":
      "The refund amount must be greater than 0.",
    "환불받을 주소가 올바르지 않습니다.":
      "The refund address is not valid.",
    "그런 표가 없습니다.":
      "That ticket does not exist.",
    "폴더가 아닙니다. 저장할 폴더를 고르세요.":
      "That is not a folder. Choose a folder to save into.",
    "이 백업은 다른 컴퓨터에서 만든 것입니다. 그때 정하신 암호를 넣어 주세요.":
      "This backup was made on another computer. Enter the password you set at that time.",
    "이 백업의 열쇠가 손상됐습니다.":
      "The key in this backup is damaged.",
    "열쇠가 짧습니다. 종이에 적힌 것을 다시 봐 주세요.":
  ...
  ja: {
    ...
    "문 앞": "入口",
    "지우기": "削除",
    "이 메모를 지울까요?": "このメモを削除しますか？",
    "메모를 저장하지 못했습니다.": "メモを保存できませんでした。",
    "메모는 1~300자 한 줄로 적어 주세요.": "メモは1〜300文字の1行で入力してください。",
    "메모는 한 회원에 50개까지 적을 수 있습니다.": "会員1人につきメモは50件までです。",
    "아직 메모가 없습니다": "メモはまだありません",
    "메모가 바뀌었습니다. 다시 열어 주세요.": "メモが変更されました。会員を開き直してください。",
    "회원 정보 설정": "会員情報の設定",
    ...
    "장사에 쓸 거예요":
      "商売に使います",
    "위의 것을 전부 하면서, 손님 QR·메뉴판·결제·기간권·회원까지 씁니다. 가게가 없어도 괜찮습니다 — 만드는 것부터 같이 합니다.":
      "上記すべてに加えて、お客様QR・メニュー・決済・定期券・会員まで使います。お店がなくても大丈夫です — 作るところから一緒にします。",
    "돕는 중":
      "協力中",
    "이 프로그램을 무엇으로 쓰시나요":
      "このプログラムを何に使いますか",
    ...
    "손님이 가게 밖에서도 QR 로 들어옵니다.":
      "お客様が店の外からもQRで入れます。",
    "지금은 같은 와이파이에 있는 손님만 들어옵니다. 밖에서도 받으려면 켜세요.":
      "今は同じWi-Fiのお客様だけ入れます。外からも受けるならオンにしてください。",
    "컴퓨터를 켜면 저절로 시작":
      "コンピュータを起動すると自動で開始",
    "정전이나 재시작 뒤에도 손님 QR 이 살아 있습니다.":
      "停電や再起動のあとも、お客様QRは生きています。",
    "바깥 연결 끄기":
      "外部接続をオフ",
    "준비물 받고 켜기":
      "必要なものを取得してオン",
    ...
    "지금이 한가한 때입니다. 시작하면 좋습니다.":
      "今が暇な時間です。始めるのに良いです。",
    "가게 영업시간을 아직 안 받았습니다. 「내 가게」에서 문 여는 시간과 닫는 시간을 적어 주시면, 한가한 때를 골라 알아서 하겠습니다.":
      "まだ営業時間をいただいていません。「私のお店」で開店・閉店の時刻を入れていただければ、暇な時間をこちらで選びます。",
    "영업시간을 읽지 못했습니다. 「내 가게」에서 다시 봐 주세요. 아무 때나 시작하지 않겠습니다.":
      "営業時間を読めませんでした。「私のお店」で確認してください。勝手な時間には始めません。",
    "쉬는 시간이 없는 가게라 한가한 때가 없습니다. 정기 휴무일을 적어 주시거나, 장사에 지장이 없는 때를 골라 「지금 시작」을 눌러 주세요.":
      "休みのないお店なので暇な時間がありません。定休日を入れるか、商売に差し支えない時間を選んで「今すぐ開始」を押してください。",
    "(문자·영수증·카운터 화면)을 보시고, 그":
    ...
    "보낼 금액이 0보다 커야 합니다.":
      "送る金額は 0 より大きくしてください。",
    "주소 검사값이 맞지 않습니다. 잘못 옮겨 적으신 것 같습니다.":
      "アドレスのチェックサムが合いません。書き写し間違いのようです。",
    "이 지갑의 주소입니다. 다른 지갑(코어 지갑이나 개인 지갑)의 주소를 넣으세요.":
      "これはこのウォレットのアドレスです。別のウォレット（コアや個人用）のアドレスを入れてください。",
    "두 번 입력한 암호가 서로 다릅니다.":
      "2 回入力したパスワードが一致しません。",
    "암호는 10자 이상이어야 합니다.":
      "パスワードは 10 文字以上にしてください。",
    "암호는 10자 이상이어야 합니다. 잊지 않으면서 남이 못 맞출 것으로 정하세요.":
      "パスワードは 10 文字以上にしてください。忘れず、他人には当てられないものにしてください。",
    "새 암호를 두 번 다르게 입력하셨습니다.":
      "新しいパスワードの入力が 2 回で異なります。",
    "잠금 해제는 10초에서 1시간 사이만 됩니다.":
      "ロック解除は 10 秒から 1 時間の間だけです。",
    "지갑 암호가 필요합니다.":
      "ウォレットのパスワードが必要です。",
    "암호를 확인하지 못했습니다. 다시 해 주세요.":
    ...
    "ravend 를 찾지 못했습니다.":
      "ravend が見つかりませんでした。",
    "이 폴더에 wallet.dat 이 없습니다. 레이븐 코어의 데이터 폴더를 골라 주세요.":
      "このフォルダーに wallet.dat がありません。Ravencoin Core のデータフォルダーを選んでください。",
    "그런 폴더가 없습니다.":
      "そのフォルダーはありません。",
    "주소를 받지 못했습니다. 인터넷 연결을 확인해 주세요.":
      "アドレスを取得できませんでした。インターネット接続をご確認ください。",
    "가게 이름이 없습니다.":
      "店名が入っていません。",
    "주문 주소는 https:// 여야 합니다.":
      "注文用アドレスは https:// で始めてください。",
    "결제 금액이 0보다 커야 합니다.":
      "決済金額は 0 より大きくしてください。",
    "이 가게에는 아직 정보가 붙어 있지 않습니다.":
      "この店にはまだ情報が付いていません。",
    ...
    "그런 예약이 없습니다.":
      "その予約はありません。",
    "방금 다른 분이 그 시간을 잡았습니다. 다른 시간을 골라 주세요.":
      "たった今、他の方がその時間を取りました。別の時間をお選びください。",
    "지난 시각은 예약할 수 없습니다.":
      "過去の時間は予約できません。",
    "환불 금액이 0보다 커야 합니다.":
      "返金額は 0 より大きくしてください。",
    ...
    "그런 표가 없습니다.":
      "そのチケットはありません。",
    "폴더가 아닙니다. 저장할 폴더를 고르세요.":
      "フォルダーではありません。保存先のフォルダーを選んでください。",
    "이 백업은 다른 컴퓨터에서 만든 것입니다. 그때 정하신 암호를 넣어 주세요.":
      "このバックアップは別のコンピューターで作られたものです。その時に決めたパスワードを入れてください。",
    "이 백업의 열쇠가 손상됐습니다.":
      "このバックアップの鍵が壊れています。",
    "열쇠가 짧습니다. 종이에 적힌 것을 다시 봐 주세요.":
  ...
  zh: {
    ...
    "메모는 한 회원에 50개까지 적을 수 있습니다.": "每位会员最多可添加50条备注。",
    "아직 메모가 없습니다": "暂无备注",
    "메모가 바뀌었습니다. 다시 열어 주세요.": "备注已更改，请重新打开会员。",
    "회원 정보 설정": "会员信息设置",
    ...
    "장사에 쓸 거예요":
      "我要用于做生意",
    "위의 것을 전부 하면서, 손님 QR·메뉴판·결제·기간권·회원까지 씁니다. 가게가 없어도 괜찮습니다 — 만드는 것부터 같이 합니다.":
      "以上全部，再加上顾客二维码、菜单、结账、期间券、会员。还没有店铺也没关系 — 我们从建店开始一起做。",
    "돕는 중":
      "协助中",
    "이 프로그램을 무엇으로 쓰시나요":
      "您用这个程序做什么",
    ...
    "지금이 한가한 때입니다. 시작하면 좋습니다.":
      "现在正空闲，适合开始。",
    "가게 영업시간을 아직 안 받았습니다. 「내 가게」에서 문 여는 시간과 닫는 시간을 적어 주시면, 한가한 때를 골라 알아서 하겠습니다.":
      "还没有您的营业时间。请在「我的店铺」填写开门和关门时间，我们会自己挑空闲时段。",
    "영업시간을 읽지 못했습니다. 「내 가게」에서 다시 봐 주세요. 아무 때나 시작하지 않겠습니다.":
      "无法读取营业时间。请在「我的店铺」中检查。我们不会随意开始。",
    "쉬는 시간이 없는 가게라 한가한 때가 없습니다. 정기 휴무일을 적어 주시거나, 장사에 지장이 없는 때를 골라 「지금 시작」을 눌러 주세요.":
      "这家店从不关门，所以没有空闲窗口。请填写固定休息日，或挑一个不影响生意的时间点按「立即开始」。",
    "(문자·영수증·카운터 화면)을 보시고, 그":
      "（短信、收据、柜台屏幕），然后输入其",
    "). 이름·기간·정지는":
      "）。姓名、期限、暂停",
    ...
    "주소 검사값이 맞지 않습니다. 잘못 옮겨 적으신 것 같습니다.":
      "地址校验值不匹配。看来是抄错了。",
    "이 지갑의 주소입니다. 다른 지갑(코어 지갑이나 개인 지갑)의 주소를 넣으세요.":
      "这是本钱包的地址。请填写其他钱包（Core 或个人钱包）的地址。",
    "두 번 입력한 암호가 서로 다릅니다.":
      "两次输入的密码不一致。",
    "암호는 10자 이상이어야 합니다.":
      "密码需要至少 10 个字符。",
    "암호는 10자 이상이어야 합니다. 잊지 않으면서 남이 못 맞출 것으로 정하세요.":
      "密码需要至少 10 个字符。请选一个自己不会忘、别人猜不到的。",
    "새 암호를 두 번 다르게 입력하셨습니다.":
      "两次输入的新密码不一样。",
    "잠금 해제는 10초에서 1시간 사이만 됩니다.":
      "解锁时长只能设在 10 秒到 1 小时之间。",
    "지갑 암호가 필요합니다.":
      "需要钱包密码。",
    "암호를 확인하지 못했습니다. 다시 해 주세요.":
      "无法验证密码。请重试。",
    ...
    "ravend 를 찾지 못했습니다.":
      "找不到 ravend。",
    "이 폴더에 wallet.dat 이 없습니다. 레이븐 코어의 데이터 폴더를 골라 주세요.":
      "此文件夹里没有 wallet.dat。请选择 Ravencoin Core 的数据文件夹。",
    "그런 폴더가 없습니다.":
      "没有这个文件夹。",
    "주소를 받지 못했습니다. 인터넷 연결을 확인해 주세요.":
      "没有取得地址。请检查网络连接。",
