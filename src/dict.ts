...
export const DICT: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    "12개월": "12 months",
    "기간권이 끝난 뒤 이름·전화·메모·추가 정보를 자동 삭제합니다. 회원번호와 출입·동의 기록은 남습니다. 횟수권은 자동 삭제하지 않습니다.": "After a period pass expires, names, phone numbers, notes and extra information are automatically deleted after the retention period. Member numbers, visit history and consent records remain. Punch cards are excluded.",
    ...
    "받는 것: {0} / 쓰는 곳: 회원 확인과 출입 / 보관: 회원권이 끝나고 {1}개월 뒤 자동 삭제 / 이 컴퓨터에만 저장돼요": "Collected: {0} / Use: member identification and entry / Retention: automatically deleted {1} months after the pass expires / Stored only on this computer",
  ...
  ja: {
    ...
    "이름+전화 전체": "名前＋電話番号全体",
    "12개월": "12か月",
    "기간권이 끝난 뒤 이름·전화·메모·추가 정보를 자동 삭제합니다. 회원번호와 출입·동의 기록은 남습니다. 횟수권은 자동 삭제하지 않습니다.": "期間券の終了後、保存期間が過ぎると名前・電話番号・メモ・追加情報を自動削除します。会員番号・入退場履歴・同意記録は残ります。回数券は対象外です。",
    ...
    "이름·전화": "名前・電話番号",
    "받는 것: {0} / 쓰는 곳: 회원 확인과 출입 / 보관: 회원권이 끝나고 {1}개월 뒤 자동 삭제 / 이 컴퓨터에만 저장돼요": "収集：{0} / 用途：会員確認と入退場 / 保存：会員券終了から{1}か月後に自動削除 / このコンピューターにのみ保存します",
  ...
  zh: {
    ...
    "이름+전화 전체": "姓名＋完整电话号码",
    "12개월": "12个月",
    "기간권이 끝난 뒤 이름·전화·메모·추가 정보를 자동 삭제합니다. 회원번호와 출입·동의 기록은 남습니다. 횟수권은 자동 삭제하지 않습니다.": "期限卡到期并超过保留期限后，自动删除姓名、电话、备注及附加信息。保留会员号、出入及同意记录。次数卡不自动删除。",
    ...
    "이름·전화": "姓名及电话",
    "받는 것: {0} / 쓰는 곳: 회원 확인과 출입 / 보관: 회원권이 끝나고 {1}개월 뒤 자동 삭제 / 이 컴퓨터에만 저장돼요": "收集：{0} / 用途：会员身份确认及出入 / 保留：会员卡到期{1}个月后自动删除 / 仅保存在此电脑上",
